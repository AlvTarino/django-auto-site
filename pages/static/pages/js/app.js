$(function () {
        ...
        if(windowWidth > 0) {
            if ($(document).scrollTop() >= 100) {
                ...
                if($('.do-sticky').length < 1) {
                    $('.company-logo img').attr('src', 'static/pages/img/logos/black-logo.png');
                }
            }
            else {
                $('.sticky-header').removeClass('header-shrink');
                if($('.do-sticky').length < 1 && $('.fixed-header').length == 0 && $('.fixed-header2').length == 0) {
                    $('.company-logo img').attr('src', 'static/pages/img/logos/logo.png');
                } else {
                    $('.company-logo img').attr('src', 'static/pages/img/logos/black-logo.png');
                }
            }
    ...
    $(document).ready(function () {
        $(".player").mb_YTPlayer(
            {
                mobileFallbackImage: 'static/pages/img/banner/banner-1.jpg'
            }
        );
    });
    ...
    $(document).on('click', '.color-plate', function () {
        ...
        $('link[id="style_sheet"]').attr('href', 'static/pages/css/skins/' + name + '.css');
    });
