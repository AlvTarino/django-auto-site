# Generated by Django 3.1.7 on 2021-07-09 09:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='car',
            name='city',
            field=models.CharField(choices=[('Kampala', 'KLA'), ('Entebbe', 'EBB'), ('Masaka', 'MSK'), ('Mbarara', 'MBR'), ('Gulu', 'GLU'), ('Mbale', 'MBL'), ('Jinja', 'JNJ'), ('Soroti', 'SRT')], max_length=100),
        ),
        migrations.AlterField(
            model_name='car',
            name='year',
